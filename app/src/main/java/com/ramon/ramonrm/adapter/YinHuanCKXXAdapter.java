...
public class YinHuanCKXXAdapter extends BaseAdapter {
    private final View.OnClickListener listener;
    private final List<AllListClass> dataList;
    Context context;
    public YinHuanCKXXAdapter(View.OnClickListener listener, List<AllListClass> dataList, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Glide.with(context).load(photoClass.getTxt1()).override(200,200).into(holder.photo);
